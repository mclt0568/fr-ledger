...
class LogSubpage extends StatefulWidget {
  const LogSubpage({Key? key}) : super(key: key);

  @override
  State<LogSubpage> createState() => _LogSubpageState();
}

class _LogSubpageState extends State<LogSubpage> {
  Map text = {};
